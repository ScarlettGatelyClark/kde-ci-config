...
class BuildManager(object):
	...
	def checkout_sources(self, doCheckout = False):
		...
		# Disable this for kf5-minimum, we opnly have a tag available.
...
def load_project_configuration( project, branchGroup, platform, compiler, variation = None ):
	...
	configFiles =  ['global.cfg', '{compiler}.cfg', '{platform}.cfg', '{branchGroup}.cfg', '{branchGroup}-{platform}.cfg', '{host}.cfg']
